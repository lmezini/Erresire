...
class CreateLensPop():
    ...
    def __init__(self, cosmo, halo_catalog, lens_catalog, source_catalog,
        ...
        # ----------------------------------------------------------
        # BASIC CHECK: CUSTOM_HALO requires custom function
        # ----------------------------------------------------------
    ...
    def create_galaxy_halo_pair(self, z_lens_min, z_lens_max, deflection_catalog):
        ...
        lens_cat_object : pandas.DataFrame
        ...
        lens_cat_object = lens_model_extra_methods.select_random_object(
            self.lens_catalog,
            z_bin_range=[z_lens_min, z_lens_max],
            mass_function_weights=self.mass_function_weights
        )

        gal_halo_mass = np.log10(lens_cat_object['h_mass'].values[0])
    ...
    def create_lens_source_pair(self, lens_cat_object, z_bin_min, z_bin_max):
        ...
        z_bin_min : float
            Lower bound of the source redshift bin.
        z_bin_max : float
            Upper bound of the source redshift bin.
        ...
        lens_geo_params : dict
            ...
            - `area_at_source` : surface area of a sphere at the source distance (Mpc²)
    ...
    def get_all_kwargs(self, LC, lens_geo_params, lens_cat_object,
        ...
        # -----------------------------------------------------------
        if self.halo_type[0] == "TABULATED_DEFLECTIONS":
            lens_model_list.append(halo_type)
    ...
    def ray_trace(self, LC, rs, kwargs_lens, z_source, lens_model):
    ...
    def monte_carlo(self, z_lens_min, z_lens_max, z_source_min,
                    ...
                    mass_function_weights=None, deflection_catalog=None):
        """
